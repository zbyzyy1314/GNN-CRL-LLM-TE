...
### Table 4: AbileneHard K=3 (ECMP=1.02) — 约束首次激活! ⭐

| 方法 | MLU | p95 | vs ECMP | λ_p95 | Safety |
|---|---|---|---|---|---|
| Baseline | 0.460 | 0.448 | +60.1% | — | — |
| CVaR | 0.406 | 0.400 | +64.8% | — | — |
| **Lagrangian** | **0.357** | **0.357** | **+69.0%** | **7.14** ✅ | — |
| **Combined** | **0.360** | **0.360** | **+68.7%** | 激活 ✅ | 0.1/步 ✅ |

**核心发现: λ=7.14! 约束真正被压回阈值内!**
```
Baseline → CVaR:  0.460→0.406 (−12%)  ← 尾部优化
CVaR → Lagrangian: 0.406→0.357 (−12%)  ← λ约束惩罚
Lagrangian → Combined:  持平          ← Safety保底
```

### Table 5: GNN vs CNN 参数量对比
...
| 拓扑 | ECMP | Combined GNN | 改进 | LP Optimal | 捕获率 |
|---|---|---|---|---|---|
| GEANT | 0.099 | **0.081** | **+17.8%** | 0.071 | 64% |
| Abilene | 0.180 | **0.087** | **+51.9%** | 0.074 | 82% |
| Abilene瓶颈 | 0.301 | 0.096 | +68.2% | — | — |
| **AbileneHard** | **1.020** | **0.360** | **+68.7%** | — | — |
